...
namespace MongoDB.Driver.Examples
{
    public class QueryPrimer : PrimerTestFixture
    {
        ...
        [Fact]
        public async Task LogicalAndAsync()
        {
            // @begin: logical-and
            // @code: start
            var collection = __database.GetCollection<BsonDocument>("restaurants");
        ...
        [Fact]
        public async Task LogicalOrAsync()
        {
            // @begin: logical-or
            // @code: start
            var collection = __database.GetCollection<BsonDocument>("restaurants");
        ...
        [Fact]
        public async Task QueryTopLevelFieldAsync()
        {
        ...
        [Fact]
        public async Task QueryEmbeddedDocumentAsync()
        {
        ...
        [Fact]
        public async Task QueryFieldInArrayAsync()
        {
        ...
        [Fact]
        public async Task GreaterThanAsync()
        {
            // @begin: greater-than
            // @code: start
            var collection = __database.GetCollection<BsonDocument>("restaurants");
        ...
        [Fact]
        public async Task LessThanAsync()
        {
            // @begin: less-than
            // @code: start
            var collection = __database.GetCollection<BsonDocument>("restaurants");
