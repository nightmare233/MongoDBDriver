...
namespace MongoDB.Driver.Tests.Samples
{
    public class AggregationSample
    {
        ...
        [Fact]
        public async Task States_with_pops_over_20000Async()
        {
        ...
        [Fact]
        public async Task States_with_pops_over_20000_queryable_methodAsync()
        {
...
#if !MONO
        [Fact]
        public async Task States_with_pops_over_20000_queryable_syntaxAsync()
        {
        ...
        [Fact]
        public async Task Average_city_population_by_stateAsync()
        {
            var pipeline = __collection.Aggregate()
        ...
        [Fact]
        public async Task Largest_and_smallest_cities_by_stateAsync()
        {
            var pipeline = __collection.Aggregate()
                .Group(x => new { State = x.State, City = x.City }, g => new { StateAndCity = g.Key, Population = g.Sum(x => x.Population) })
...
#if !MONO
        [Fact]
        public async Task Largest_and_smallest_cities_by_state_queryable_syntaxAsync()
        {
